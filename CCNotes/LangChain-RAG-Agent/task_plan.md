...
- [ ] 1.1 理解 Prompt 的核心要素：角色、指令、上下文、输出格式
- [ ] 1.2 掌握 Few-shot Prompting（给示例让模型模仿协议风格）
- [ ] 1.3 掌握结构化输出控制：让 LLM 输出 JSON / 固定字段格式
- [ ] 1.4 实操：纯 Python SDK 写一个"需求 → 协议字段表"的 Prompt 并调通
- **Status:** in_progress
